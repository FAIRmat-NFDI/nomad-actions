...
class AtomsExportEntriesActionEntryPoint(ActionEntryPoint):
    ...
    def load(self):
        ...
        from nomad_ml_workflows.actions.export_atoms.workflows import (
            AtomsExportEntriesWorkflow,
            AtomsExtractEntriesWorkflow,
            AtomsReadArchivesWorkflow,
        )
        ...
        return Action(
            ...
            workflow=AtomsExportEntriesWorkflow,
            child_workflows=[AtomsExtractEntriesWorkflow, AtomsReadArchivesWorkflow],
            activities=[
                prepare_manifest,
                read_archives_and_write_output_json,
                read_archives_and_write_table_rows,
